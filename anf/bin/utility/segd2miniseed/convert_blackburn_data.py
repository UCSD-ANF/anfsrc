...
mxdbuf = 0.3 #This is the maximum internal data buffer size in GB
...
wdir = '/anf/ANZA/SJFZ/nodal_blackburn/miniseed_test' #Output Directory
...
def worker(args):
    ...
    segd = SegD(path, 'ZB', sta, 1000.0, samprate, chanprfx, mxdbuf, st2cc)
