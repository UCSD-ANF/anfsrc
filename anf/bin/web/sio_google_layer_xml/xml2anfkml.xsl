    ...
    <xsl:template match="/">
        <kml xmlns="http://www.opengis.net/kml/2.2">
            ...
            <Document>
                ...
                <xsl:for-each select="distinct-values( document('/anf/web/vhosts/anf.ucsd.edu/htdocs/cachexml/stations/sio_google_layer.xml')/station_list/stations/station/Network )">
                ...
                <xsl:for-each select="document('/anf/web/vhosts/anf.ucsd.edu/htdocs/cachexml/stations/sio_google_layer.xml')/station_list/snets/snet">
