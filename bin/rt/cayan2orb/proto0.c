...
void p0_start2orb(int orbfd, unsigned char *buf)
{
  ...
  *(orbpkt->parts.src_loc)=0;
  ...
  p0_numframes(orbpkt, epochstr, buf);
  p0_voltage(orbpkt, epochstr, buf);
...
void p0_data2orb(int orbfd, unsigned char *buf)
{
  ...
  *(orbpkt->parts.src_loc)=0;
  ...
  p0_pressure(orbpkt, epochstr, buf);
  p0_nwind0(orbpkt, epochstr, buf);
  p0_ewind0(orbpkt, epochstr, buf);
  p0_windgust0(orbpkt, epochstr, buf);
  p0_dgust0(orbpkt, epochstr, buf);
  p0_nwind1(orbpkt, epochstr, buf);
  p0_ewind1(orbpkt, epochstr, buf);
  p0_windgust1(orbpkt, epochstr, buf);
  p0_dgust1(orbpkt, epochstr, buf);
  p0_temp0(orbpkt, epochstr, buf);
  p0_temp1(orbpkt, epochstr, buf);
  p0_humidity(orbpkt, epochstr, buf);
  p0_rain(orbpkt, epochstr, buf);
  p0_solar(orbpkt, epochstr, buf);
