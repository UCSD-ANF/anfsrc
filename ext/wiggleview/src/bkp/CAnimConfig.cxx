...
SoBlinker*
AnimConfig::loadFiles(const float& speed,const SbViewportRegion& region)
{
	SoSeparator* files = loadFile(m_config.getString());
...
/*
SbString
AnimConfig::getDisplayMode()
{
	return m_displayMode;
}

SbString
AnimConfig::getBindCenter()
{
	return m_bindCenter;
}

SbString
AnimConfig::getFrameRate()
{
	return m_frameRate;
}

SbString
AnimConfig::getTextDisplay()
{
