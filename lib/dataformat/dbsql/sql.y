...
Specifically, this file is adapted from 'sql1.y', available from:
	
	http://examples.oreilly.com/lex/progs.tar.gz
*/
...
rollback_statement:
 ...
 /* The lex&yacc book has a bug whereby the select_statement requires the
    INTO clause.  This is fixed in the errata, but I fix it differently 
    here. --tobin */

select_statement:
		SELECT opt_all_distinct selection opt_into table_exp
	;
