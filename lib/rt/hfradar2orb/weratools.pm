...
BEGIN {
	# Public:
	$Verbose = 0;
	$codeVersion = '%ProcessingTool: "weratools.pm" 1.00';
...
sub lluv2hash {
	...
	my( %lluv_parsemap ) = (
		...
		"weratools_ver"		=> "ProcessingTool:\\s+\"weratools.pm\"\\s+($PosFP)",
...
sub datablock_rb2lluv {
	...
	foreach $i (0..$#Bearings) {
		...
		# bearing from polar coords reported by WERA ( E = 0, CCW) 
...
sub pack_LLUV {
	...
	push @outblock, "%Manufacturer: Helzel Messtechnik GmbH";
